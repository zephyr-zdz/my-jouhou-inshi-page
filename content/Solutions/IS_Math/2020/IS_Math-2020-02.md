...
3. For a nonnegative real number $D$, let $K_D$ be the set of points whose distance from $K$ is at most $D$. Show that the area $A_D = \iint_{K_D} \mathrm{d}x \, \mathrm{d}y$ of $K_D$ is represented as
